...
function LangMessage({ role, children }) {
  return <div className="relative flex flex-row gap-2 border rounded border-gray-300 p-2 pt-3">
    <div className="absolute top-[-8px] left-[7px] border rounded border-gray-300 bg-white text-xs px-1 bg-gray-100 small-caps font-bold">
...
function LangPrompt({ onSubmit }) {
  ...
  return <LangMessage role="user">
    <input ref={queryRef} type="text" className="w-full outline-none bg-gray-100" onKeyDown={handleKeyDown} />
  </LangMessage>
}
